...
public class AdapterRCVShowAllItem extends RecyclerView.Adapter<AdapterRCVShowAllItem.ViewHolder> {
    List<ItemSell> itemSellList;
    private OnItemRCVClickListener onItemRCVClickListener;

    public void setDataAdapter(List<ItemSell> itemSellList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_rcv_show_all_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            linearLayout = itemView.findViewById(R.id.layout_item_show_all_item);
            imgAvatar = itemView.findViewById(R.id.img_item_show_all_item);
            salePercent = itemView.findViewById(R.id.tv_sale_percen_item_show_all_item);
            salePrice = itemView.findViewById(R.id.tv_price_item_show_all_item);
        }
    }
}
